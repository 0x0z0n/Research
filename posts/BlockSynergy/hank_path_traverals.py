...
pubkey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGq2rhNctMG0AuhlqP4k9kopeqDHD+IcMgqQWPoREnDw blocksynergy-writeup"
...
payload_b64 = base64.b64encode(_json.dumps(contract_json).encode()).decode()

print(execute_as_walter(f"echo {payload_b64} | base64 -d > /tmp/hank_contract.json"))
print(execute_as_walter("cat /tmp/hank_contract.json"))  # verify it wrote correctly
