...
#ifndef _NFSV3_H_RPCGEN
#define _NFSV3_H_RPCGEN
...
typedef u_quad_t u_xint64_t;

typedef u_int u_xint32_t;
...
#if defined(__STDC__) || defined(__cplusplus)
extern  bool_t xdr_u_xint64_t (XDR *, u_xint64_t*);
extern  bool_t xdr_u_xint32_t (XDR *, u_xint32_t*);
...
extern  bool_t xdr_xbool_t (XDR *, xbool_t*);
...
#else /* K&R C */
extern bool_t xdr_u_xint64_t ();
extern bool_t xdr_u_xint32_t ();
