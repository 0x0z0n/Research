...
bool_t
xdr_u_xint64_t (XDR *xdrs, u_xint64_t *objp)
{
...
bool_t
xdr_u_xint32_t (XDR *xdrs, u_xint32_t *objp)
{
	register int32_t *buf;
...
bool_t
xdr_xbool_t (XDR *xdrs, xbool_t *objp)
{
	register int32_t *buf;
...
xdr_specdata3 (XDR *xdrs, specdata3 *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_u_xint32_t (xdrs, &objp->specdata1))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->specdata2))
		 return FALSE;
	return TRUE;
}
...
xdr_nfstime3 (XDR *xdrs, nfstime3 *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_u_xint32_t (xdrs, &objp->seconds))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->nseconds))
		 return FALSE;
	return TRUE;
}
...
xdr_fattr3 (XDR *xdrs, fattr3 *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_mode3 (xdrs, &objp->mode))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->nlink))
		 return FALSE;
	 ...
	 if (!xdr_specdata3 (xdrs, &objp->rdev))
		 return FALSE;
	 if (!xdr_u_xint64_t (xdrs, &objp->fsid))
		 return FALSE;
...
xdr_ACCESS3args (XDR *xdrs, ACCESS3args *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_nfs_fh3 (xdrs, &objp->object))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->access))
		 return FALSE;
	return TRUE;
}
...
xdr_FSSTAT3resok (XDR *xdrs, FSSTAT3resok *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_size3 (xdrs, &objp->afiles))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->invarsec))
		 return FALSE;
	return TRUE;
}
...
xdr_FSINFO3resok (XDR *xdrs, FSINFO3resok *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_post_op_attr (xdrs, &objp->obj_attributes))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->rtmax))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->rtpref))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->rtmult))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->wtmax))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->wtpref))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->wtmult))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->dtpref))
		 return FALSE;
	 if (!xdr_size3 (xdrs, &objp->maxfilesize))
		 return FALSE;
	 if (!xdr_nfstime3 (xdrs, &objp->time_delta))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->properties))
		 return FALSE;
	return TRUE;
}
...
xdr_PATHCONF3resok (XDR *xdrs, PATHCONF3resok *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_post_op_attr (xdrs, &objp->obj_attributes))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->linkmax))
		 return FALSE;
	 if (!xdr_u_xint32_t (xdrs, &objp->name_max))
		 return FALSE;
	 if (!xdr_xbool_t (xdrs, &objp->no_trunc))
		 return FALSE;
	 if (!xdr_xbool_t (xdrs, &objp->chown_restricted))
		 return FALSE;
	 if (!xdr_xbool_t (xdrs, &objp->case_insensitive))
		 return FALSE;
	 if (!xdr_xbool_t (xdrs, &objp->case_preserving))
		 return FALSE;
	return TRUE;
}
